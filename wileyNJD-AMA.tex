...
\begin{figure}[ht]
   \centering \includegraphics[width=1.1\textwidth]{fill_empty.JPG}
...
\begin{figure}[ht]
  \centering \includegraphics[width=1.1\textwidth]{fill_some.JPG}
...
\begin{figure}[h]
  \centering \includegraphics[width=1.1\textwidth]{final_data.JPG}
...
\begin{figure}[H]
  \centering \includegraphics[width=1.1\textwidth]{analysis_options.JPG}
...
\begin{figure}[ht]
  \centering \includegraphics[width=1.1\textwidth]{ANCOVA_res.JPG}
...
\begin{figure}[ht]
  \centering \includegraphics[width=1.1\textwidth]{one_stage.JPG}
...
\begin{figure} [ht] 
  \centering \includegraphics[width=1.1\textwidth]{onestage_int.JPG}
...
\begin{figure} [H]
  \centering \includegraphics[width=1.1\textwidth]{forest_funnel.JPG}
