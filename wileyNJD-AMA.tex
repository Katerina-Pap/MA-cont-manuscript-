...
\begin{table}[t]
\caption{Models for the within-trial residual variances}
\label{tab:resvar}
\begin{tabular}{cc}
\toprule
\begin{tabular}[c]{@{}c@{}}Arm- and study-specific \\ $\sigma^2_{ik}$:\end{tabular} & varies by arm and study; the most flexible approach                   \\
\begin{tabular}[c]{@{}c@{}}Study-specific \\ $\sigma^2_{i}$:\end{tabular}           & varies by study but assumed equal between treatment and control arms; \\
\begin{tabular}[c]{@{}c@{}}Arm-specific\\ $\sigma^{2}_{k}$:\end{tabular}            &                                                                       \\
\begin{tabular}[c]{@{}c@{}}One variance\\ $\sigma^2$:\end{tabular}                  &                                                                       \\ \bottomrule
\end{tabular}
\end{table}
